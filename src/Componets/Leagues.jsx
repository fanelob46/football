...
try {
 ...
 .filter((leg) => {
  ...
  <div key={leg.id} leg={leg} className='kobus:py-10'>
  <img  src={leg?.league?.logo}  className='w-20 h-20 kobus:w-[150px] kobus:h-[200px] '/>
...
<div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4  py-8 justify-items-center'>
  ...
  <div className=''>
  <ReactPaginate className='text-sm kobus:text-2xl flex place-items-center space-x-2 pl-36 sm:pl-80 sm:space-x-4 md:space-x-6 lg:space-x-8 md:pl-[580px] lg:pl-[800px] xl:pl-[1100px] pc:pl-[1400px] kobus:pl-[1850px]'
  ...
  previousLinkClassName={"previousBttn p-2 border border-[#2b2eff] rounded-md text-[#2b2eff]  transition"}
  nextLinkClassName={"nextBttn p-2 border border-[#2b2eff] rounded-md text-[#2b2eff]  transition"}
  disabledClassName={"paginationDisabled"}
  activeClassName={"paginationActive p-2 border rounded-md text-white bg-[#2b2eff]"}
  />
  </div>
